...
import clinicImage from '../assets/clinic.jpg'; // Corrected import
    ...
    <div className="container my-5">
      <div className="row align-items-center g-5">
        ...
        <div className="col-md-6">
          ...
          <p className="mt-3 mb-1"><strong>Clinic Hours:</strong> Open 8 AM – Closes 10 PM</p>
          <p className="mb-1"><strong>Areas Served:</strong> Vijay Nagar and nearby areas</p>

          <a
            href="https://www.google.com/maps/place/Aarogyam+Physiotherapy+Clinic/@22.7367824,75.8857747,17z"
            target="_blank"
